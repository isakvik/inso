...
calculate_curve_from_time :: proc(time_at: f64, hobj: ^Hitobject, path: ^Slider_Path) -> (pos_at: vec2) {
...
write_instances_from_path :: proc(
    ...
    // todo(yokes): add buffer push here? start_pos should always be drawn
